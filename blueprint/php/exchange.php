...
<div class="MyExchange-container container">
 ...
 <div class="exchange-slider mask container-fluid m-0 p-0 pt-5">
  <!-- Background image -->
  <div class="text-center bg-image pt-5">
   <div class="mask bg-opac-black h-50 mt-5">
    <div class="d-flex justify-content-center align-items-center h-100">
     <div>
      <h1 class="mb-3 text-white">This is where it all starts.</h1>
      <h4 class="mb-3 text-light font-weight-normal"><small>We have been working with some fine talents in the company
 ...
 <div class="exchange-profile bg-image">
  <div class="container">
   <div class="row p-5">
    <!--Profile Card 1-->
    <div class="col-md-3">
    ...
    <div class="col-md-3">
     <div class="card profile-card">
      <div class="background-block">
       <img
        src="https://images.pexels.com/photos/1072179/pexels-photo-1072179.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
        alt="profile-sample1" class="background" />
      </div>
      <div class="profile-thumb-block">
    ...
    <div class="col-md-3">
     <div class="card profile-card">
      <div class="background-block">
       <img
        src="https://images.pexels.com/photos/629167/pexels-photo-629167.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
        alt="profile-sample1" class="background" />
      </div>
      <div class="profile-thumb-block">
