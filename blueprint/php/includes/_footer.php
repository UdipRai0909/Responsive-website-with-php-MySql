...
<!-- Footer Container -->
<div class="MyFooter-container ml-0 mr-0 bg-opac-black8 text-muted">
  ...
  <div class="container">
   <div class="row">
    <div class="col-md-6 bg-opac-black p-3">
     <div class="row">
      ...
      <div class="col-md-6 px-4">
       <h5 class="text-muted font-weight-bold"> About Company</h5>
    ...
    <div class="col-md-6">
     <div class="row">
      <div class="col-md-6 px-4">
       <h5 class=" text-muted font-weight-bold"> Help us</h5>
       <div class="row ">
        <div class="col-md-6">
         <ul>
          <li> <a href="#"> Home</a> </li>
      ...
      <div class="col-md-6 ">
       <h5 class="text-muted font-weight-bold"> Newsletter</h5>
